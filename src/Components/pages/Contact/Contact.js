      ...
      <section>
        ...
        <div className="container mx-auto">
          <div className="md:flex md:gap-x-4 py-10 mx-5">
            ...
            <div data-aos="fade-left" className="flex flex-col md:mt-0 mt-5">
              <div data-aos="fade-down" className="py-2">
              ...
              <div className="md:grid grid-cols-2 gap-4 md:mt-10 flex flex-col">
                <div data-aos="fade-left" className="flex items-center gap-x-1">
                  <div>
