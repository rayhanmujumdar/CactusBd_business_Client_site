      ...
      <div className="container mx-auto">
        <div className="md:flex md:gap-x-4 py-10 mx-5">
          ...
          <div className="md:w-1/2 w-full">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.152063889147!2d90.4089470509952!3d23.777598793576992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7ec1756be2f%3A0xc140a22928e6af72!2sCactus%20BD!5e0!3m2!1sen!2sbd!4v1670945396265!5m2!1sen!2sbd"
              width="100%"
              height="400"
              allowfullscreen=""
              loading="lazy"
            ...
            <div className="md:grid grid-cols-2 gap-4 md:mt-10 flex flex-col">
              <div className="flex items-center gap-x-1">
                ...
                <div>
                  ...
                  <p>6/2 Kazi nazrul islam Rd, Lalmatia, Dhaka-1207</p>
                </div>
              </div>
              <div className="flex items-center gap-x-1">
                <div>
                ...
                <div>
                  ...
                  <p>015245421221 (Sales)</p>
                  <p>01776464695 (Admin)</p>
                </div>
              </div>
              <div className="flex items-center gap-x-1">
                <div>
